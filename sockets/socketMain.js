...
setInterval(() => {
    // console.log('emision cada 30 fps');
    if (players.length > 0) {
...
// Aqui entra cuando se conecta un usuario
io.sockets.on('connect', (socket) => {
    ...
    socket.on('init', (data) => {
            ...
            // Emite un mensaje cada 30 fps al cliente con la posicion del usuario
            setInterval(() => {
        ...
        // the client sent over a tick. That means we know what direction to move the socket0
    socket.on('tick', (data) => {
        console.log('speed plater es', player);
